public class Perfil {
    ...
    public void setAvaliacao(float nota) {
		somaAvaliacoes += nota;
		numeroAvaliacoes ++;
		avaliacao = somaAvaliacoes/numeroAvaliacoes;
	}

    public Caroneiro getCaroneiro(){ return caroneiro; }

    public void setCaroneiro (Caroneiro caroneiro) { this.caroneiro = caroneiro; }

    public Caronante getCaronante(){ return caronante; }

    public void setCaronante (Caronante caronante) { this.caronante = caronante; }
